...
public class BuyMedicine extends AppCompatActivity {
    ...
    private String[] package_details = {
            ...
            "Provides relief from vitamin B deficiencies\n" +
                    "Helps in formation red blood cells\n" +
                    "Maintains healthy nervous system",
            "It promotes health as well as skin benefit.\n" +
                    "It helps reduce skin blemish and pigmentation.\n" +
                    "It act as safeguard the skin form the harsh UVA and UVB sun rays.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Goto = findViewById(R.id.buttonGoToCart);
        ...
        ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(BuyMedicine.this,BuyMedDetail.class);
